...
HRESULT playerManager::init()
{
	...
	_A_saveBeforWeapon.name="술";
	_A_saveBeforWeapon.img = IMAGEMANAGER->findImage("술");
	_A_saveBeforArmor.name = "권법가 도복";
	_A_saveBeforArmor.img = IMAGEMANAGER->findImage("권법가 도복");
	_S_saveBeforWeapon.name = "청룡도";
	_S_saveBeforWeapon.img = IMAGEMANAGER->findImage("청룡도");
	_S_saveBeforArmor.name = "가죽 갑옷";
	_S_saveBeforArmor.img = IMAGEMANAGER->findImage("가죽 갑옷");
